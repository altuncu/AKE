...
class RakunDetector:
    def __init__(self, hyperparameters, verbose=True, thes=None, wiki=None, pos=False):
    ...
    def find_keywords(self, document, input_type="file", validate=False):
        ...
        total_kws = heuristics.apply_heuristics(document, total_kws, self.thes, self.wiki, self.pos, "en")    
